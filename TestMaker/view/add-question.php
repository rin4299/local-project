    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-10">
          ...
          <form method="POST" action="../TestMaker/controller/add_question.php">
            <div class="form-row">
              <div class="col">
            ...
            <div class="form-row">
              ...
              <div class="col">
                <div class="form-group">
                  ...
                  <select class="form-control" id="categorySelect" name="subject">
                    <option value="Algorithm">Category 1</option>
                    <option value="Math">Category 2</option>
                  </select>
                </div>
